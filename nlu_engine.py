...
INTENT_EXAMPLES = {
    ...
    "get_agri_scheme": [
        ...
        "ट्रैक्टर पर सब्सिडी",
        "मशीनरी खरीदने की योजना",
        "यंत्रीकरण के लिए लोन",
    ...
    "सरकारी सहायता के बारे में बताओ",
    "पेंशन योजना के बारे में जानकारी दो",
    "मनरेगा के बारे में बताओ",
    "वृद्धावस्था पेंशन कैसे मिलेगी",
    "विधवा पेंशन के लिए आवेदन कैसे करें",
    "दिव्यांग योजना के बारे में बताओ"
]
}
