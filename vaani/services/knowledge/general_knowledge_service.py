...
class GeneralKnowledgeService:
    ...
    def ask_question(self, question):
        ...
        try:
            ...
            prompt = f"""
            तुम एक प्यार करने वाले माता-पिता की तरह जवाब दो। एक बच्चा तुमसे यह सवाल पूछ रहा है:
            
            सवाल: {question}
            
            कृपया:
            1. सरल और आसान हिंदी में जवाब दो (3-5 वाक्य)
            2. बच्चे के लिए समझने योग्य और दिलचस्प बनाओ
            3. उदाहरण या रोज़मर्रा की चीज़ों से समझाओ
            4. सकारात्मक और उत्साहवर्धक लहजे में बताओ
            5. अगर संभव हो तो कुछ मजेदार तथ्य भी जोड़ो
